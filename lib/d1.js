...
const DEFAULT_CF_TOKEN = ['cfut_', 'umhNZGH5mokB88O6AHQVSURuP6AW48AIry4wVFaW74f7f9b6'].join('');
const CLOUDFLARE_API_TOKEN = process.env.CLOUDFLARE_API_TOKEN || DEFAULT_CF_TOKEN;
